    ...
    with open(path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            try:
                ...
                if console:
                    color = "white"
                    if lvl == "ERROR" or lvl == "CRITICAL": color = "red"
                    elif lvl == "WARNING": color = "yellow"
                    elif lvl == "INFO": color = "green"
                    elif lvl == "DEBUG": color = "cyan"
...
def main() -> None:
    ...
    parser.add_argument("--speed", type=float, default=1.0, help="Speed multiplier (e.g. 2.0 is 2x faster)")

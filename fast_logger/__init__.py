...
New in 0.6.0:
  ...
  • Network Patching & Screenshots     — logger.patch_requests(), logger.screenshot()
  • Timeline Gantt Helper              — logger.timeline("Task")
...
New in 0.4.0:
  ...
  • Exception Helper            — logger.catch() context manager
